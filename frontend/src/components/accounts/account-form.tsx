    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-xs">
      <div className="w-full max-w-lg rounded-xl border bg-white p-6 shadow-xl space-y-4 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="account-name" className="block text-xs font-semibold text-zinc-700">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <label htmlFor="account-domain" className="block text-xs font-semibold text-zinc-700">
                Website Domain
              </label>
              <input
                id="account-domain"
            ...
            <div>
              <label htmlFor="account-campaign" className="block text-xs font-semibold text-zinc-700">
                Assigned Campaign
              </label>
              <select
                id="account-campaign"
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <label htmlFor="account-industry" className="block text-xs font-semibold text-zinc-700">
                Industry
              </label>
              <input
                id="account-industry"
            ...
            <div>
              <label htmlFor="account-employees" className="block text-xs font-semibold text-zinc-700">
                Employee Count
              </label>
              <input
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <label htmlFor="account-city" className="block text-xs font-semibold text-zinc-700">
                City
              </label>
              <input
                id="account-city"
            ...
            <div>
              <label htmlFor="account-country" className="block text-xs font-semibold text-zinc-700">
                Country
              </label>
              <input
                id="account-country"
          ...
          <div>
            <label htmlFor="account-status" className="block text-xs font-semibold text-zinc-700">
              Account Status
            </label>
            <select
              id="account-status"
