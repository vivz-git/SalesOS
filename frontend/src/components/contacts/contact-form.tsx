      ...
      <div className="w-full max-w-lg rounded-xl border bg-white p-6 shadow-xl space-y-4 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <label htmlFor="first-name" className="block text-xs font-semibold text-zinc-700">
            ...
            <div>
              <label htmlFor="last-name" className="block text-xs font-semibold text-zinc-700">
          ...
          <div>
            <label htmlFor="contact-account" className="block text-xs font-semibold text-zinc-700">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <label htmlFor="contact-email" className="block text-xs font-semibold text-zinc-700">
                Work Email
              </label>
              <input
                id="contact-email"
            ...
            <div>
              <label htmlFor="contact-phone" className="block text-xs font-semibold text-zinc-700">
                Phone Number
              </label>
              <input
                id="contact-phone"
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <label htmlFor="contact-title" className="block text-xs font-semibold text-zinc-700">
                Job Title
              </label>
              <input
                id="contact-title"
            ...
            <div>
              <label htmlFor="contact-department" className="block text-xs font-semibold text-zinc-700">
                Department
              </label>
              <input
          ...
          <div>
            <label htmlFor="contact-linkedin" className="block text-xs font-semibold text-zinc-700">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <label htmlFor="contact-status" className="block text-xs font-semibold text-zinc-700">
                Status
              </label>
              <select
                id="contact-status"
            ...
            <div className="flex items-center gap-2 pt-5">
              ...
              />
              <label htmlFor="is-primary" className="text-xs font-semibold text-zinc-700">
