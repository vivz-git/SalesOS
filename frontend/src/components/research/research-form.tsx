    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-xs">
      <div className="w-full max-w-lg rounded-xl border bg-white p-6 shadow-xl space-y-4 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="brief-account" className="block text-xs font-semibold text-zinc-700">
          ...
          <div>
            <label htmlFor="brief-contact" className="block text-xs font-semibold text-zinc-700">
          ...
          <div>
            <label htmlFor="brief-summary" className="block text-xs font-semibold text-zinc-700">
          ...
          <div>
            <label htmlFor="brief-findings" className="block text-xs font-semibold text-zinc-700">
