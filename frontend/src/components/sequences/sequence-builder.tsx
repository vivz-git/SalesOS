...
export function SequenceBuilder({
 ...
 onClick={handleSave}
 disabled={saving}
 className="inline-flex items-center gap-1.5 rounded-lg bg-accent px-3.5 py-1.5 text-xs font-semibold text-accent-foreground hover:bg-accent-hover transition-colors shrink-0 shadow-sm focus:outline-none"
 >
 ...
 {msg && (
 <div className="rounded-lg border border-indigo-200 bg-indigo-50 p-3 text-xs font-semibold text-indigo-900">
 {msg}
 </div>
 )}
 ...
 className="mt-1 w-full max-w-md rounded-lg border border-slate-200 p-2 text-xs text-slate-900 focus:border-indigo-500 focus:outline-none"
 />
 </div>
 ...
 <span className="flex h-6 w-6 items-center justify-center rounded-full bg-indigo-100 text-xs font-bold text-indigo-900">
 {st.step_number}
 </span>
 ...
 className="p-1 text-slate-400 hover:text-red-600 transition-colors focus:outline-none rounded-sm"
 title="Remove step"
 >
 ...
 className="mt-1 w-full rounded-lg border border-slate-200 bg-white p-2 text-xs text-slate-900 focus:border-indigo-500 focus:outline-none"
 />
 </div>
 ...
 <label className="font-semibold text-slate-600">Template Body Content</label>
 <textarea
 rows={3}
 value={st.template_body ||""}
 onChange={(e) => handleStepChange(idx,"template_body", e.target.value)}
 className="mt-1 w-full rounded-lg border border-slate-200 bg-white p-2 text-xs font-normal text-slate-900 focus:border-indigo-500 focus:outline-none"
 />
 </div>
 </div>
 ))}
 ...
 className="inline-flex items-center gap-1.5 rounded-lg border border-dashed border-slate-300 px-3.5 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-100 transition-colors focus:outline-none"
 >
